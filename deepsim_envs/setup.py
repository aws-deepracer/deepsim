...
setup_args = {
    ...
    "package_dir": {"": "."},
    "description": "Open-source library to provide DeepSim RL Environment interface compatible with UDE.",
    "long_description": read("README.md"),
    "long_description_content_type": 'text/markdown',
    "author": "Amazon Web Services",
    "url": "https://github.com/aws-deepracer/deepsim/tree/main/deepsim_envs",
