...
from deepsim_btree.composites.rand_selector import RandomSelector
...
class RandomSelectorTest(TestCase):
    def setUp(self) -> None:
        pass
    ...
    def test_current_child(self):
        ...
        children = [Failure(), running_child, Failure()]
        selector = RandomSelector(children=children)
