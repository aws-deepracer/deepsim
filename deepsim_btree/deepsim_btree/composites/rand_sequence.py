...
#################################################################################
"""A class for random sequence node."""
import random
...
class RandomSequence(Composite):
    """
    Sequence behaviour that executes the children behaviour in random order.
    """
    def __init__(self,
        ...
        """
        Initialize RandomSequence class.
        ...
        """
        super(RandomSequence, self).__init__(children=children,
                                             name=name)
